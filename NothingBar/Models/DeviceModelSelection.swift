...
enum DeviceModelCatalog {
    ...
    static let all: [DeviceModelSelection] = [
        ...
        .init(id: "ear3A.black", model: .ear3A(.black), colorName: "Black", deviceImage: .buds(left: .ear3ABlackLeft, right: .ear3ABlackRight)),
        .init(id: "ear3A.white", model: .ear3A(.white), colorName: "White", deviceImage: .buds(left: .ear3AWhiteLeft, right: .ear3AWhiteRight)),
        .init(id: "ear3A.yellow", model: .ear3A(.yellow), colorName: "Yellow", deviceImage: .buds(left: .ear3AYellowLeft, right: .ear3AYellowRight)),
        .init(id: "ear3A.pink", model: .ear3A(.pink), colorName: "Pink", deviceImage: .buds(left: .ear3APinkLeft, right: .ear3APinkRight)),
